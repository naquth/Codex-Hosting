...
import {
  Server, CreditCard, TicketIcon, TrendingUp,
  Activity, AlertCircle, CheckCircle, Clock, ArrowRight, Plus,
} from 'lucide-react';
import ClientLayout from '../../components/ClientLayout';

const stats = [
  { label: 'Active Services',  value: '3',      change: '+1 this month', icon: Server,     color: 'blue'   },
  { label: 'Pending Invoices', value: '$12.47',  change: 'Due in 5 days', icon: CreditCard, color: 'yellow' },
  { label: 'Open Tickets',     value: '1',       change: 'Awaiting reply',icon: TicketIcon, color: 'purple' },
  { label: 'Uptime (30d)',     value: '99.9%',   change: 'All systems up',icon: TrendingUp, color: 'green'  },
];
