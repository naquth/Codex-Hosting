...
const services = [
  ...
  },
  {
    ...
    cpu: '2 vCores',
    disk: '40GB',
    ipPort: '185.123.45.67',
    created: '2024-12-10',
  },
  {
    id: 4,
    name: 'Lavalink Node EU',
    type: 'Lavalink',
    status: 'pending',
    plan: 'Lavalink Starter',
    expires: '2025-07-30',
    ram: '1GB',
    cpu: '100%',
    disk: '10GB',
    ipPort: 'lava.codex.host:2333',
    created: '2025-06-01',
  },
];
            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  {svc.status === 'active' && (
                    <>
                      <button className="p-2 bg-green-500/10 hover:bg-green-500/20 text-green-400 rounded-lg transition-colors" title="Start">
                        <Play size={15} />
                      </button>
                      <button className="p-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-lg transition-colors" title="Stop">
                        <Square size={15} />
                      </button>
                      <button className="p-2 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-400 rounded-lg transition-colors" title="Restart">
                        <RotateCcw size={15} />
                      </button>
                    </>
                  )}
