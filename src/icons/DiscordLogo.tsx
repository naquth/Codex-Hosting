// DiscordLogo.tsx
// Accepts both `className` (for Tailwind sizing) AND `size` (like Lucide icons)
// so it can be safely used in any context without rendering as a giant SVG.
...
const DiscordLogo = ({ className, size, style }: DiscordLogoProps) => {
  ...
  return (
    <svg
      ...
      height={dimension}
      style={style}
      // Fallback: if neither className nor size provides dimensions, use 1em
      aria-hidden="true"
    >
      <path
        fill="currentColor"
